 ...
 */
{
    ...
    let enlacesTercerParrafo = document.getElementsByTagName("p")[2].getElementsByTagName("a").length;
    ...
    informacion.innerHTML += "<p><b>El total de enlaces en el tercer párrafo es: " + enlacesTercerParrafo + "</b></p>"
}
